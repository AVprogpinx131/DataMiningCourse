...
features_scaled = scaler.fit_transform(data[['esmaneKasutus', 'pindala', 'mahtBruto', 'maxKorrusteArv', 'tubadeArv', 'ehitisAlunePind', 'suletudNetoPind']])
...
dendrogram(linked, orientation='top', labels=data['Buildings'].astype(str).values, distance_sort='descending', show_leaf_counts=True, leaf_rotation=90)  # Rotate labels
